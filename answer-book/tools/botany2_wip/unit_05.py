    ...
    steps=[
      ...
      S('s2_link','equation','The link reaction',1,'Link reaction',
        lines=["Pyruvic acid from glycolysis enters the",
               "mitochondrion first.",
               "There it undergoes OXIDATIVE DECARBOXYLATION:",
...
C.append(Q(U, 'respiratory_quotient', 'SAQ', 'saq1', 167, 52,
    ...
    steps=[
      S('s1_define','equation','Definition and formula',1,'Definition',
        lines=["The RESPIRATORY QUOTIENT (RQ) is the ratio of",
               "the volume of CO2 GIVEN OUT to the volume of",
               "O2 TAKEN IN, in a given time at standard",
