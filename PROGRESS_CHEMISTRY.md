...
| 4 | Chemistry machine gates (ledger check, animation vocab) | ☐ — **4 scar candidates now waiting to seed it** (see 2026-07-27 session) |
| 5 | Chemistry render surface (particle-box, then Three.js molecule/orbital) | ☐ (founder-gated) — **particle-box is now P0, the next chemistry action** |
