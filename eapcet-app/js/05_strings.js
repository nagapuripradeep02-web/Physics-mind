...
var STR = {
  ...
  /* show me your working: the photo on the fix page (paid) */
  photo_title: 'Show me your working',
  photo_intro: 'Take a photo of the page you worked this on. It is read once and the tick-list below is what it saw.',
  photo_camera: 'Take a photo',
  photo_gallery: 'Pick from gallery',
  photo_privacy: 'Your photo is sent once to read it, then discarded. It is not stored.',
  photo_reading: 'Reading your working. This takes a few seconds.',
  photo_locked: 'Reading a photo of your working is part of the plan.',
  photo_locked_cta: 'See the plan',
  photo_down: 'The photo could not be read just now. The worked solution above still works. Try again in a moment.',
  photo_unreadable: 'That photo could not be read. Take it again in more light, straight above the page.',
  photo_off_topic: 'That page does not look like working for this question. Take a photo of your working for this one.',
  photo_bad_file: 'That file is not a photo this phone can open.',
  photo_too_large: function (mb) { return 'That photo is too large (' + mb + ' MB). Take it again.'; },
  photo_reason: {
    quiet: 'Photo reading is resting for today. The worked solution above still works.',
    cap: 'That is the last photo for today. The worked solution above still works.',
    busy: 'Give it a short moment and try the photo again.',
    down: 'The photo could not be read just now. Try again in a moment.',
    no_solution: 'This question has no verified solution to read your working against.',
    too_large: 'That photo is too large. Take it again.'
  },
  photo_state: { found: 'Seen', not_found: 'Not seen', unsure: 'Unclear' },
  photo_step: function (n, text) { return 'Step ' + n + (text ? ': ' + text : ''); },
  photo_saw: function (ev) { return 'On your page: ' + ev; },
  photo_flip: 'Change',
  photo_final: function (v) { return 'Your final answer, as read: ' + v + '.'; },
  photo_final_option: function (n) { return 'That is option (' + n + ').'; },
  photo_final_no_option: 'That matches no option.',
  photo_final_none: 'No final answer could be read on the page.',
  photo_diverges: function (n, text) { return 'Your working leaves the verified solution at step ' + n + (text ? ': ' + text : '') + '.'; },
  photo_follows: 'Your working follows every verified step that could be read.',
  photo_confirm: 'That is what I wrote',
  photo_retake: 'Try another photo',
  photo_saved: 'Saved. This counts as evidence for this question.',
  photo_saved_anchored: function (n, picked) { return 'On paper you reached (' + n + '). You picked (' + picked + ').'; },
  photo_saved_typed: function (kind) { return 'The number on your page comes from ' + kind + '.'; },
  photo_left: function (n) { return n === 1 ? 'One photo left today.' : n + ' photos left today.'; },
