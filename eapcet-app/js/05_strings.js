...
var STR = {
  ...
  sol_photo_caption_send: 'Your photo. It is sent once to be read and solved, then dropped. It is not stored.',
  sol_reading: 'Reading the question. This takes a few seconds.',
  sol_solving: 'Solving. This can take up to half a minute.',
  sol_still: 'Still solving. A hard question takes longer.',
  sol_locked: 'Solving a photo of a question is part of the plan.',
  sol_locked_cta: 'See the plan',
  sol_down: 'The question could not be solved just now. Try again in a moment.',
  sol_reason: {
    quiet: 'Solving is resting for today. Type the question to look for it in the pool of past questions.',
    cap: 'That is the last photo for today.',
    busy: 'Give it a short moment and try the photo again.',
    down: 'The question could not be solved just now. Try again in a moment.',
    unreadable: 'The question could not be read from that photo. Take it again in more light, straight above the page, with the whole question in the frame.',
  ...
  /* solutions: the reviewer — "I tried, here is my work" (85_review.js) */
  rev_final_q: 'First, your final answer. Type it in the box below, with its unit. If you have none yet, say so.',
  rev_final_placeholder: 'Your final answer, with its unit',
  rev_chip_no_final: 'I have no answer yet',
  rev_work_photo: 'Now take a photo of your working. One page, the whole page in the frame, in good light.',
  rev_photo_caption: 'Your working. It is sent once to be checked, then dropped. It is not stored.',
  rev_checking_q: 'Solving the question first, to have something sure to check against. This can take up to half a minute.',
  rev_checking_work: 'Checking your working, line by line. This can take up to a minute.',
  rev_still: 'Still checking. A long page takes longer.',
  rev_locked: 'Checking a photo of your working is part of the plan.',
  rev_down: 'Your working could not be checked just now. Try again in a moment.',
  rev_reason: {
    quiet: 'Checking is closed for today. Ask for the solution instead.',
    cap: 'That is the last check for today.',
    busy: 'Wait a short moment and send the photo again.',
    down: 'Your working could not be checked just now. Try again in a moment.',
    unreadable: 'Your working could not be read from that photo. Take it again in more light, straight above the page, with the whole page in the frame.',
    no_reference: 'The answer to this question is not verified yet, so your working cannot be checked.',
    confirm_first: 'The answer to this question is not verified yet, so your working cannot be checked.',
    too_large: 'That photo is too large. Take it again.'
  },
  rev_noref_eyebrow: 'Not checked',
  rev_noref_title: 'Your working cannot be checked for this question.',
  rev_noref_body: 'The answer to this question is not verified yet, so there is nothing sure to check your working against. Your working photo was dropped. Ask for the solution to see the workings.',
  rev_eyebrow: { correct: 'Correct', error: 'One line to fix', unsure: 'Not sure' },
  rev_correct_title: 'Correct. Your working reaches the right answer.',
  rev_method: function (m) { return 'Your method: ' + m; },
  rev_final_read: function (v) { return 'Your final answer, as read: ' + v + '.'; },
  rev_final_key: 'It matches the key.',
  rev_line_n: function (n) { return 'Line ' + n + ' on your page'; },
  rev_should: 'What should be here',
  rev_class: {
    concept: 'Concept: the idea used on this line does not apply here.',
    method: 'Method: a step is missing, or the steps are in the wrong order.',
    calculation: 'Calculation: the numbers or the algebra on this line.',
    reading: 'Reading: a value was copied wrongly from the question.',
    convention: 'Sign or unit: a sign or a unit on this line is wrong.',
    presentation: 'Writing: the line does not say what you mean.'
  },
  rev_ask_retake: 'Your working could not be checked with confidence from this photo. Take the photo again, straight above the page, with every line in the frame.',
  rev_ask_value: function (n) { return 'Line ' + n + ' could not be read. Type the value you got at line ' + n + ' in the box below.'; },
  rev_value_placeholder: function (n) { return 'The value at line ' + n; },
  rev_attempt: function (k, n) { return 'Attempt ' + k + ' of ' + n; },
  rev_chip_next: 'Fix it and send the next photo',
  rev_chip_retake: 'Take the photo again',
  rev_chip_solution: 'Show me the full solution',
  rev_chip_similar: 'Similar question',
  rev_chip_another: 'Another question',
  rev_next_photo: 'Fix that line, then take a photo of the page again.',
  rev_solution_now: 'Here is the full solution.',
  rev_exhausted: 'That was the third attempt. Here is the full solution.',
  rev_dispute: 'This review is wrong? Tell us',
  rev_disputed: 'Noted. A teacher will check it.'
};
