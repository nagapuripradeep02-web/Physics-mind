...
```json
{"verdicts": [
 {"id": "prj_3f9a1c02", "techniques": ["equations of motion", "resolving vectors"], "beyond": [], "verdict": "within"},
 {"id": "prj_9c1d0e77", "techniques": ["Lagrangian mechanics"], "beyond": ["Euler-Lagrange equation used to get the equation of motion"], "verdict": "beyond"}
]}
```
