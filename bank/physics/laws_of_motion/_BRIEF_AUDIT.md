# Audit brief — worked solutions for the laws-of-motion bank
...
Input:   the slice file named in your dispatch, under `bank/physics/laws_of_motion/_audit_slices/`
Output:  `C:\Tutor\physics-mind-eapcet-corpus\bank\physics\laws_of_motion\_audit\<audit_file>` — one file per
