...
| **space_wave_propagation** | Line-of-sight; >30 MHz; FM, TV, microwave | atomic | ✅ | — | [bandwidth_signal_vs_channel] | [satellite_communication, frequency_modulation, antenna_range_formula] | Indian-anchor: FM Rainbow 102.6 MHz. **Cycle break (2026-06-13):** removed `antenna_range_formula` from Requires — space-wave (line-of-sight) is the parent mode; the range formula quantifies it (now in Required-by). |
