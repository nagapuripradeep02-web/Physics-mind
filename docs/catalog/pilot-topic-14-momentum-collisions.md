...
| **inelastic_collision_atomic** | Momentum conserved; KE NOT conserved (some converted to heat, sound, deformation). Coefficient of restitution e ∈ [0,1] characterises energy retention | atomic | ✅ | — | [conservation_of_momentum_atomic, coefficient_of_restitution_atomic] | [perfectly_inelastic_collision_atomic, real_world_collisions_nano] | MC-G6; **cognitive_error_target:** "real collisions are elastic" → most real collisions are partly inelastic |
