...
| 3 | **conformations of butane** | C₄H₁₀, torsion about C2–C3 | the same dihedral, now with a CH₃ on each end | φ; E(φ) with **four minima**; anti 0, gauche **+3.8**, CH₃/H ecl **+16**, syn **+19** kJ/mol | φ slider + which substituent sits on the front carbon |
