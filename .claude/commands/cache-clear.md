---
description: Clear the 4 PhysicsMind cache tables (simulation, lesson, response, session_context) per CLAUDE.md §3. Never touches sacred tables.
allowed-tools: [mcp__supabase__execute_sql]
---

Per CLAUDE.md §3, clear the 4 PhysicsMind cache tables. Run as FOUR SEPARATE queries — never batch.
...
## NEVER DELETE — sacred tables (CLAUDE.md §3)
...
- `student_confusion_log` (159+ rows of real student confusion)
