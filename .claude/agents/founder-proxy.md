...
> Loop contract: dispatched by docs/CHAPTER_LOOP.md at Checkpoints A (design), B (build), C (handover); your report is persisted by the loop session, you write nothing.
