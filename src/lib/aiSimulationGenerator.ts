...
export const CONCEPT_RENDERER_MAP: Record<string, "circuit_live" | "particle_field" | "graph_interactive" | "mechanics_2d" | "wave_canvas" | "optics_ray" | "field_3d" | "thermodynamics"> = {
    ...
    // Ch.8.5 Friction — ALSO in PCPL_CONCEPTS below; the PCPL set takes precedence
    // at the sim-assembler site. Without this entry the id fell through to the
    // step-4 substring loop / "particle_field" default in resolveRendererType().
    friction_static_kinetic:        "mechanics_2d",
    ...
    electric_flux:                  "field_3d",
    gauss_law:                      "field_3d",
    gauss_law_sphere:               "field_3d",
    gauss_law_solid_sphere:         "field_3d",
    gauss_law_line:                 "field_3d",
    gauss_law_sheet:                "field_3d",
    force_on_charge_in_field:       "field_3d",
    electric_potential_meaning:     "field_3d",
    electric_potential_point_charge: "field_3d",
    equipotential_surfaces:         "field_3d",
    electric_potential_dipole:      "field_3d",
    electric_potential_system_of_charges: "field_3d",
    potential_energy_system_of_charges: "field_3d",
    ...
    magnetic_field_circular_loop:   "field_3d",
    moving_coil_galvanometer:       "field_3d",
    galvanometer_to_ammeter_voltmeter: "field_3d",
    bar_magnet_as_dipole:           "field_3d",
    amperes_circuital_law:          "field_3d",
    magnetic_force_moving_charge:   "field_3d",
    magnetic_force_direction_right_hand_rule: "field_3d",
    magnetic_force_perpendicular_no_work: "field_3d",
    circular_motion_charge_in_uniform_B: "field_3d",
    helical_motion_charge_in_uniform_B: "field_3d",
    cyclotron_period_independent_of_speed: "field_3d",
...
const MECHANICS_SCENARIO_MAP: Record<string, string> = {
    ...
    current_loop_acts_as_dipole:    "circular",
    parallel_currents_force:        "circular",
...
const FIELD_3D_SCENARIO_MAP: Record<string, Field3DConfig["scenario_type"]> = {
    ...
    electric_potential_meaning:     "point_charge_positive",
    electric_potential_point_charge: "point_charge_positive",
    equipotential_surfaces:         "point_charge_positive",
    electric_potential_dipole:      "dipole_potential",
    electric_potential_system_of_charges: "system_of_charges",
    potential_energy_system_of_charges: "system_pe_assembly",
    potential_energy_in_external_field: "pe_external_field",
    electric_potential_3d:          "dipole",
    parallel_plate_capacitor_field: "parallel_plates",
    magnetic_field_solenoid:        "solenoid_field",
    magnetic_field_concept_B:       "straight_wire_current",
    magnetic_field_wire:            "straight_wire_current",
    biot_savart_law:                "biot_savart_element",
    amperes_circuital_law:          "amperes_circuital_law",
    gauss_law_line:                 "gauss_law_line",
    gauss_law_sheet:                "gauss_law_sheet",
    magnetic_force_moving_charge:   "lorentz_force_uniform_field",
    magnetic_force_direction_right_hand_rule: "rhr_force_direction",
    magnetic_force_perpendicular_no_work: "magnetic_no_work",
    circular_motion_charge_in_uniform_B: "radius_in_uniform_field",
    helical_motion_charge_in_uniform_B: "helix_in_uniform_field",
    cyclotron_period_independent_of_speed: "cyclotron_period",
    torque_on_current_loop_in_field:"torque_on_loop_uniform_field",
    current_loop_acts_as_dipole:    "current_loop_acts_as_dipole",
    parallel_currents_force:        "parallel_currents_force",
    magnetic_field_circular_loop:   "magnetic_field_circular_loop",
    moving_coil_galvanometer:       "moving_coil_galvanometer",
    galvanometer_to_ammeter_voltmeter: "galvanometer_to_ammeter_voltmeter",
    bar_magnet_as_dipole:           "bar_magnet_as_dipole",
    electric_dipole_in_field:       "dipole_in_uniform_field",
    bar_magnet_in_uniform_field:    "bar_magnet_in_uniform_field",
    gauss_law_magnetism:            "gauss_law_magnetism",
