...
export const VALID_CONCEPT_IDS: ReadonlySet<string> = new Set([
    ...
    // a reversal through v=0 shows ΔK is measured from the STARTING energy,
    // never the final ½mv² alone; and a derivation W_net = ma·d = ½mv² −
    // ½mv₀² is checked live against a stamped flag. Does NOT cover what
