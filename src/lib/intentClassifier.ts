...
export const VALID_CONCEPT_IDS: ReadonlySet<string> = new Set([
    ...
    // series_lcr_circuit now built, see below; ac_power_factor/
    ...
    // concepts — ac_voltage_capacitor/phasors/series_lcr_circuit now built,
    // see below; ac_power_factor/lc_oscillations/transformer follow — NOT
    // yet built, do not invent routing for them).
    'ac_voltage_inductor',
    ...
    // AC map (phasors/series_lcr_circuit now built, see below;
    // ac_power_factor/lc_oscillations/transformer follow — the latter three
    // NOT yet built, do not invent routing for them).
    ...
    // FOURTH of the Ch.7 AC map (series_lcr_circuit now built, see below;
    // ac_power_factor/lc_oscillations/transformer follow — NOT yet built,
    ...
    // are ac_power_factor / lc_oscillations, later — this concept's own
    // deliberate withholdings; its power HUD slot stays empty on purpose).
    'series_lcr_circuit',
