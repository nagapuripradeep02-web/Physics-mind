...
export const VALID_CONCEPT_IDS: ReadonlySet<string> = new Set([
    ...
    // (transformer follows — NOT yet built, do not invent routing for it).
    // Does NOT cover element mechanisms, impedance, resonance, or power
    // (settled one-clause callbacks from the six sealed siblings), driven/
    // forced oscillation (that was series_lcr_circuit), or mutual coupling/
    // voltage transformation (deferred to transformer).
    'lc_oscillations',
