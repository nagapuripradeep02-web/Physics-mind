...
export const VALID_CONCEPT_IDS: ReadonlySet<string> = new Set([
    ...
    // AC map (phasors (now built, see below)/series_lcr_circuit/ac_power_factor/
    // lc_oscillations/transformer follow — the latter four NOT yet built, do
    // not invent routing for them).
    ...
    // FOURTH of the Ch.7 AC map (series_lcr_circuit/ac_power_factor/
