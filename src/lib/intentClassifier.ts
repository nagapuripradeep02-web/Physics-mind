...
export const VALID_CONCEPT_IDS: ReadonlySet<string> = new Set([
    ...
    // and the latched start-line flag reads "W gravity = 0.0 J"). Friction is
    ...
    // the two losses instead of cancelling them (the latched line reads
    // "W gravity = 0.0 J, W friction = −27.4 J" — the PRIMARY aha). The
    // friction arrow debuts flipping 180° at the turnaround (the mechanism:
    // friction re-aims with the motion, gravity never does), and two flags on
