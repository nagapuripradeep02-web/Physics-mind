/**
 * TEMP seed — work_done_by_constant_force into simulation_cache so
 ...
 * row. Delete after the visual gate (mirrors _seed_newton_third_law_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_work_done_by_constant_force_cache.ts
 */
...
const CONCEPT_ID = 'work_done_by_constant_force';
