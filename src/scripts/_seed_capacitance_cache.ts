/**
 * TEMP seed — capacitance into simulation_cache so `npm run visual:eyes` /
 ...
 * Delete after the visual gate (mirrors _seed_magnetisation_and_intensity_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_capacitance_cache.ts
 */
