/**
 * TEMP seed — amperes_circuital_law into simulation_cache so
 ...
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_amperes_circuital_law_cache.ts
 */
...
const CONCEPT_ID = 'amperes_circuital_law';
