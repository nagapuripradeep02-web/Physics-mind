/**
 * TEMP seed — inductance into simulation_cache so
 ...
 * row. Delete after the visual gate (mirrors _seed_eddy_currents_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_inductance_cache.ts
 */
