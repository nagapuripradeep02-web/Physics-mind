/**
 * TEMP seed — conservative_vs_nonconservative_forces into simulation_cache so
 ...
 * row. Delete after the visual gate (mirrors _seed_positive_negative_zero_work_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_conservative_vs_nonconservative_forces_cache.ts
 */
...
const CONCEPT_ID = 'conservative_vs_nonconservative_forces';
