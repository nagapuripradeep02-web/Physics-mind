/**
 * TEMP seed — series_lcr_circuit into simulation_cache so `npm run visual:eyes` /
 ...
 * Delete after the visual gate (mirrors _seed_phasors_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_series_lcr_circuit_cache.ts
 */
...
const CONCEPT_ID = 'series_lcr_circuit';
