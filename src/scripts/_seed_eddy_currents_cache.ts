/**
 * TEMP seed — eddy_currents into simulation_cache so
 ...
 * row. Delete after the visual gate (mirrors _seed_motional_emf_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_eddy_currents_cache.ts
 */
...
const CONCEPT_ID = 'eddy_currents';
