/**
 * TEMP seed — lc_oscillations into simulation_cache so `npm run visual:eyes` /
 ...
 * Delete after the visual gate (mirrors _seed_ac_power_factor_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_lc_oscillations_cache.ts
 */
...
const CONCEPT_ID = 'lc_oscillations';
