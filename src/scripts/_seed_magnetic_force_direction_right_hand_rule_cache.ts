/**
 * TEMP seed — magnetic_force_direction_right_hand_rule into simulation_cache so
 ...
 * visual gate (mirrors the retired _seed_magnetic_field_concept_B_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_magnetic_force_direction_right_hand_rule_cache.ts
 */
...
const CONCEPT_ID = 'magnetic_force_direction_right_hand_rule';
