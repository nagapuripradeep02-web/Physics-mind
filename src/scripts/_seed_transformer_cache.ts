/**
 * TEMP seed — transformer into simulation_cache so `npm run visual:eyes` /
 ...
 * Delete after the visual gate (mirrors _seed_lc_oscillations_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_transformer_cache.ts
 */
