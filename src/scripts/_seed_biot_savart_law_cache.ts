/**
 * TEMP seed — biot_savart_law into simulation_cache so
 ...
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_biot_savart_law_cache.ts
 */
...
const CONCEPT_ID = 'biot_savart_law';
