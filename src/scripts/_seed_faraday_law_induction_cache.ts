/**
 * TEMP seed — faraday_law_induction into simulation_cache so
 ...
 * row. Delete after the visual gate (mirrors _seed_magnetisation_and_intensity_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_faraday_law_induction_cache.ts
 */
...
const CONCEPT_ID = 'faraday_law_induction';
