/**
 * TEMP seed — magnetic_field_solenoid into simulation_cache so
 ...
 * visual gate (mirrors _seed_amperes_circuital_law_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_magnetic_field_solenoid_cache.ts
 */
...
const CONCEPT_ID = 'magnetic_field_solenoid';
