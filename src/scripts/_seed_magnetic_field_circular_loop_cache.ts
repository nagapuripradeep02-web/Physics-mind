/**
 * TEMP seed — magnetic_field_circular_loop into simulation_cache so
 ...
 * visual gate (mirrors the retired _seed_current_loop_acts_as_dipole_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_magnetic_field_circular_loop_cache.ts
 */
...
const CONCEPT_ID = 'magnetic_field_circular_loop';
