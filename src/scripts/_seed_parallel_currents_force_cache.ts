/**
 * TEMP seed — parallel_currents_force into simulation_cache so
 ...
 * visual gate.
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_parallel_currents_force_cache.ts
 */
...
const CONCEPT_ID = 'parallel_currents_force';
