/**
 * TEMP seed — pure_rolling into simulation_cache so `npm run visual:eyes` can
 ...
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_pure_rolling_cache.ts
 */
