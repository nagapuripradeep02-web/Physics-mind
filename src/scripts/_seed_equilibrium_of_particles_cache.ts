/**
 * TEMP seed — equilibrium_of_particles into simulation_cache so `npm run visual:eyes` can
 ...
 * script after the visual gate (mirrors _seed_block_on_incline_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_equilibrium_of_particles_cache.ts
 */
...
const CONCEPT_ID = 'equilibrium_of_particles';
