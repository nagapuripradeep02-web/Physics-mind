/**
 * TEMP seed — rolling_friction into simulation_cache so `npm run visual:eyes` can
 ...
 * script after the visual gate (mirrors _seed_normal_force_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_rolling_friction_cache.ts
 */
...
const CONCEPT_ID = 'rolling_friction';
