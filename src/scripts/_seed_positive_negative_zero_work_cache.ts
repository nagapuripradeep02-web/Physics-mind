/**
 * TEMP seed — positive_negative_zero_work into simulation_cache so
 ...
 * row. Delete after the visual gate (mirrors _seed_work_done_by_constant_force_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_positive_negative_zero_work_cache.ts
 */
...
const CONCEPT_ID = 'positive_negative_zero_work';
