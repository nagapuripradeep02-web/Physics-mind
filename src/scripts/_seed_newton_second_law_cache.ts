/**
 * TEMP seed — newton_second_law into simulation_cache so
 ...
 * row. Delete after the visual gate (mirrors _seed_newton_first_law_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_newton_second_law_cache.ts
 */
...
const CONCEPT_ID = 'newton_second_law';
