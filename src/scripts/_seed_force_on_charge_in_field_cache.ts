/**
 * TEMP seed — force_on_charge_in_field into simulation_cache so
 ...
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_force_on_charge_in_field_cache.ts
 */
...
const CONCEPT_ID = 'force_on_charge_in_field';
