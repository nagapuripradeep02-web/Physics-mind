/**
 * TEMP seed — uniform_circular_motion into simulation_cache so `npm run visual:eyes` can
 ...
 * script after the visual gate (mirrors _seed_equilibrium_of_particles_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_uniform_circular_motion_cache.ts
 */
...
const CONCEPT_ID = 'uniform_circular_motion';
