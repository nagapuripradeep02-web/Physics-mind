/**
 * TEMP seed — normal_force into simulation_cache so `npm run visual:eyes` can
 ...
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_normal_force_cache.ts
 */
