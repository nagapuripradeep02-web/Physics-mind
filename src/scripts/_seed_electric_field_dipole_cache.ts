/**
 * TEMP seed — electric_field_dipole into simulation_cache so
 ...
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_electric_field_dipole_cache.ts
 */
...
const CONCEPT_ID = 'electric_field_dipole';
