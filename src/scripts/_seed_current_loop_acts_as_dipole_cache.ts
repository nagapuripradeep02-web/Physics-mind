/**
 * TEMP seed — current_loop_acts_as_dipole into simulation_cache so
 ...
 * visual gate (mirrors the retired _seed_amperes_circuital_law_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_current_loop_acts_as_dipole_cache.ts
 */
...
const CONCEPT_ID = 'current_loop_acts_as_dipole';
