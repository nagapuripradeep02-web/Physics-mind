/**
 * TEMP seed — circular_motion_charge_in_uniform_B into simulation_cache so
 ...
 * visual gate (mirrors _seed_cyclotron_period_independent_of_speed_cache.ts /
 * _seed_magnetic_field_solenoid_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_circular_motion_charge_in_uniform_B_cache.ts
 */
...
const CONCEPT_ID = 'circular_motion_charge_in_uniform_B';
