/**
 * TEMP seed — cyclotron_period_independent_of_speed into simulation_cache so
 ...
 * visual gate (mirrors the retired _seed_fcw_cache.ts / _seed_charge_distribution_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_cyclotron_period_independent_of_speed_cache.ts
 */
...
const CONCEPT_ID = 'cyclotron_period_independent_of_speed';
