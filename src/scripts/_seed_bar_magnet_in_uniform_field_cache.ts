/**
 * TEMP seed — bar_magnet_in_uniform_field into simulation_cache so
 ...
 * row. Delete after the visual gate.
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_bar_magnet_in_uniform_field_cache.ts
 */
...
const CONCEPT_ID = 'bar_magnet_in_uniform_field';
