/**
 * TEMP seed — magnetic_force_moving_charge into simulation_cache so
 ...
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_magnetic_force_moving_charge_cache.ts
 */
...
const CONCEPT_ID = 'magnetic_force_moving_charge';
