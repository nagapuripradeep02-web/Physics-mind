/**
 * TEMP seed — ac_voltage_resistor into simulation_cache so `npm run visual:eyes` /
 ...
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_ac_voltage_resistor_cache.ts
 */
...
const CONCEPT_ID = 'ac_voltage_resistor';
