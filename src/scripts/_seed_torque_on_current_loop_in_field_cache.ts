/**
 * TEMP seed — torque_on_current_loop_in_field into simulation_cache so
 ...
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_torque_on_current_loop_in_field_cache.ts
 */
...
const CONCEPT_ID = 'torque_on_current_loop_in_field';
