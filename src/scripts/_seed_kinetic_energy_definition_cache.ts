/**
 * TEMP seed — kinetic_energy_definition into simulation_cache so
 ...
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_kinetic_energy_definition_cache.ts
 */
...
const CONCEPT_ID = 'kinetic_energy_definition';
