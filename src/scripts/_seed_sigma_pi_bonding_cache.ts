/**
 * TEMP seed — sigma_pi_bonding into simulation_cache so
 ...
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_sigma_pi_bonding_cache.ts
 */
...
const CONCEPT_ID = 'sigma_pi_bonding';
