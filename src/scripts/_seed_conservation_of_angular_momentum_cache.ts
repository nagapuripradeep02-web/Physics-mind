/**
 * TEMP seed — conservation_of_angular_momentum into simulation_cache so
 ...
 * Mirrors _seed_capacitance_cache.ts exactly.
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_conservation_of_angular_momentum_cache.ts
 */
...
const CONCEPT_ID = 'conservation_of_angular_momentum';
