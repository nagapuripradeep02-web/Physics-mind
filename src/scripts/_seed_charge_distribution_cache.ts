/**
 * TEMP seed — charge_distribution into simulation_cache so
 ...
 * visual gate (mirrors the retired _seed_fcw_cache.ts / _seed_dipole_in_field_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_charge_distribution_cache.ts
 */
...
const CONCEPT_ID = 'charge_distribution';
