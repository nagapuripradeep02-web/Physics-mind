/**
 * TEMP seed — block_on_incline into simulation_cache so `npm run visual:eyes` can
 ...
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_block_on_incline_cache.ts
 */
...
const CONCEPT_ID = 'block_on_incline';
