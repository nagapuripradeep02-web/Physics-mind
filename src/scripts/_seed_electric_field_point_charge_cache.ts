/**
 * TEMP seed — electric_field_point_charge into simulation_cache so
 ...
 * row. Delete after the visual gate (mirrors _seed_coulombs_law_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_electric_field_point_charge_cache.ts
 */
...
const CONCEPT_ID = 'electric_field_point_charge';
