/**
 * TEMP seed — ac_voltage_inductor into simulation_cache so `npm run visual:eyes` /
 ...
 * Delete after the visual gate (mirrors _seed_ac_voltage_resistor_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_ac_voltage_inductor_cache.ts
 */
...
const CONCEPT_ID = 'ac_voltage_inductor';
