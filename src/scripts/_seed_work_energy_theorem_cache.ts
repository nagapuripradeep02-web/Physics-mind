/**
 * TEMP seed — work_energy_theorem into simulation_cache so
 ...
 * row. Delete after the visual gate (mirrors _seed_kinetic_energy_definition_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_work_energy_theorem_cache.ts
 */
...
const CONCEPT_ID = 'work_energy_theorem';
