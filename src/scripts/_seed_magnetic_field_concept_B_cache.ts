/**
 * TEMP seed — magnetic_field_concept_B into simulation_cache so
 ...
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_magnetic_field_concept_B_cache.ts
 */
...
const CONCEPT_ID = 'magnetic_field_concept_B';
