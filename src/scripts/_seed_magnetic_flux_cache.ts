/**
 * TEMP seed — magnetic_flux into simulation_cache so
 ...
 * row. Delete after the visual gate (mirrors _seed_faraday_law_induction_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_magnetic_flux_cache.ts
 */
...
const CONCEPT_ID = 'magnetic_flux';
