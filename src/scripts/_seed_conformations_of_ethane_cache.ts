/**
 * TEMP seed — conformations_of_ethane into simulation_cache so
 ...
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_conformations_of_ethane_cache.ts
 */
...
const CONCEPT_ID = 'conformations_of_ethane';
