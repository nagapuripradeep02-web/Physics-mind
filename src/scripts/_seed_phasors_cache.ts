/**
 * TEMP seed — phasors into simulation_cache so `npm run visual:eyes` /
 ...
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_phasors_cache.ts
 */
