/**
 * TEMP seed — electric_dipole_in_field into simulation_cache so
 ...
 * row. Delete after the visual gate (mirrors _seed_force_on_charge_in_field_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_electric_dipole_in_field_cache.ts
 */
...
const CONCEPT_ID = 'electric_dipole_in_field';
