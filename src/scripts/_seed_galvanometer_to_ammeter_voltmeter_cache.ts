/**
 * TEMP seed — galvanometer_to_ammeter_voltmeter into simulation_cache so
 ...
 * visual gate (mirrors the retired _seed_moving_coil_galvanometer_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_galvanometer_to_ammeter_voltmeter_cache.ts
 */
...
const CONCEPT_ID = 'galvanometer_to_ammeter_voltmeter';
