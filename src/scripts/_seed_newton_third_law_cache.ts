/**
 * TEMP seed — newton_third_law into simulation_cache so
 ...
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_newton_third_law_cache.ts
 */
...
const CONCEPT_ID = 'newton_third_law';
