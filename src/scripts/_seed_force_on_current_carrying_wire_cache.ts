/**
 * TEMP seed — force_on_current_carrying_wire into simulation_cache so
 ...
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_force_on_current_carrying_wire_cache.ts
 */
