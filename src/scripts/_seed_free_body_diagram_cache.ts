/**
 * TEMP seed — free_body_diagram into simulation_cache so `npm run visual:eyes` /
 ...
 * retired _seed_charge_distribution_cache.ts / _seed_dipole_in_field_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_free_body_diagram_cache.ts
 */
...
const CONCEPT_ID = 'free_body_diagram';
