/**
 * TEMP seed — gauss_law into simulation_cache so `npm run visual:eyes` /
 ...
 * retired _seed_electric_flux_cache.ts / _seed_charge_distribution_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_gauss_law_cache.ts
 */
