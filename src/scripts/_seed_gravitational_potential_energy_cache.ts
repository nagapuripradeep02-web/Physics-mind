/**
 * TEMP seed — gravitational_potential_energy into simulation_cache so
 ...
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_gravitational_potential_energy_cache.ts
 */
...
const CONCEPT_ID = 'gravitational_potential_energy';
