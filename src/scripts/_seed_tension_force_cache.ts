/**
 * TEMP seed — tension_force into simulation_cache so `npm run visual:eyes` can
 ...
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_tension_force_cache.ts
 */
...
const CONCEPT_ID = 'tension_force';
