/**
 * TEMP seed — connected_bodies into simulation_cache so `npm run visual:eyes` can
 ...
 * script after the visual gate (mirrors _seed_free_body_diagram_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_connected_bodies_cache.ts
 */
...
const CONCEPT_ID = 'connected_bodies';
