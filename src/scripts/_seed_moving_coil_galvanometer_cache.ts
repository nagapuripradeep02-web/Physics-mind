/**
 * TEMP seed — moving_coil_galvanometer into simulation_cache so
 ...
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_moving_coil_galvanometer_cache.ts
 */
...
const CONCEPT_ID = 'moving_coil_galvanometer';
