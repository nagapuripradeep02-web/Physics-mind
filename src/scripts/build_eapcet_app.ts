...
const bases = (HOSTED || PREVIEW)
    ? {
        ...
        EP_SOLVE_BASE: (process.env.EP_SOLVE_BASE || '').trim(),
        EP_REVIEW_BASE: (process.env.EP_REVIEW_BASE || '').trim(),
    ...
    : { EP_CHAT_BASE: '', EP_STATE_BASE: '', EP_PAY_BASE: '', EP_PHOTO_BASE: '', EP_SOLVE_BASE: '', EP_REVIEW_BASE: '', EP_AUTH_BASE: '', EP_AUTH_ANON: '', EP_STAFF_WORD: '' };
