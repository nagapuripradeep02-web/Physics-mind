/**
 * TEMP seed — friction_force into simulation_cache so `npm run visual:eyes` can
 ...
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_friction_force_cache.ts
 */
...
const CONCEPT_ID = 'friction_force';
