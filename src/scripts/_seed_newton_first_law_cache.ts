/**
 * TEMP seed — newton_first_law into simulation_cache so
 ...
 * row. Delete after the visual gate (mirrors _seed_inductance_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_newton_first_law_cache.ts
 */
...
const CONCEPT_ID = 'newton_first_law';
