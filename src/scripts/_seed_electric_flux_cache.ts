/**
 * TEMP seed — electric_flux into simulation_cache so `npm run visual:eyes` /
 ...
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_electric_flux_cache.ts
 */
...
const CONCEPT_ID = 'electric_flux';
