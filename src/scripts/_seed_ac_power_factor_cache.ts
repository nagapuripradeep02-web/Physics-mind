/**
 * TEMP seed — ac_power_factor into simulation_cache so `npm run visual:eyes` /
 ...
 * Delete after the visual gate (mirrors _seed_series_lcr_circuit_cache.ts).
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_ac_power_factor_cache.ts
 */
...
const CONCEPT_ID = 'ac_power_factor';
