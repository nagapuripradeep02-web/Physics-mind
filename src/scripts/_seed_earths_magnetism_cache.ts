/**
 * TEMP seed — earths_magnetism into simulation_cache so
 ...
 *
 * Run: npx tsx --env-file=.env.local src/scripts/_seed_earths_magnetism_cache.ts
 */
...
const CONCEPT_ID = 'earths_magnetism';
