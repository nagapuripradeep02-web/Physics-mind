...
export const PAPER_PATTERNS: Record<string, PaperPattern> = {
    ...
    // Sr. Zoology is the SAME ABC_60 shape, read off the book's own Model Paper-1
    // (p.75): Section A 'Answer ALL' 10 x 2 = 20, Section B 'any SIX' of the eight
    // printed x 4 = 24, Section C 'any TWO' of the three printed x 8 = 16, total 60.
    // The 15-mark practical follows `botany`/`zoology`, both lab subjects on this
    // same table; only the written 60 is sourced from the book.
    zoology_2: { label: 'Zoology-II', total: 60, internal: { marks: 15, kind: 'practical' }, sections: ABC_60, wef: '2026-27' },
};
...
export const answerBookQuestionSchema = z
    .object({
        ...
        subject: z.enum(['physics', 'chemistry', 'mathematics', 'mathematics_1b', 'botany', 'zoology', 'zoology_2']),
